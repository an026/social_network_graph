...
class MongoBridge(object):
    """
    MongoBridge reads raw data from the mongo database for the Data database.
    """
    ...
    def __init__(self):
        """
        Connects to the mongo server, Data database, and the Artists collection
        """
        self.__mongoClient = pymongo.MongoClient("mongodb://localhost:27017/")
        self.__myCollection = self.__mongoClient["Data"]["Artists"]
